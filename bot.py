...
# ⚡ HARDCORE SPEED SYSTEM
SPEED_CONFIGS = {
    "1x": {"multiplier": 1, "threads": 5, "delay": 3, "label": "Normal", "credits": 1},
    "2x": {"multiplier": 2, "threads": 10, "delay": 2, "label": "Fast", "credits": 2},
    "3x": {"multiplier": 3, "threads": 15, "delay": 1, "label": "Very Fast", "credits": 3},
    "5x": {"multiplier": 5, "threads": 25, "delay": 0.5, "label": "Extreme", "credits": 5},
    "10x": {"multiplier": 10, "threads": 50, "delay": 0.1, "label": "CRASH MODE", "credits": 10},
    "20x": {"multiplier": 20, "threads": 100, "delay": 0, "label": "NUCLEAR", "credits": 20},
}
